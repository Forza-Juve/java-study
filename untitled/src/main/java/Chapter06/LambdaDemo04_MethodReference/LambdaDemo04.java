...
import Chapter06.LambdaDemo01_Calculator.Calculator;

public class LambdaDemo04 {
    public static void main(String[] args) {
        Calculator calculator1 = (a,b)-> Chapter06.LambdaDemo04_MethodReference.Calculator.add(a,b);
        int sum1 = calculator1.compute(10,20);
        System.out.println(sum1);

        Calculator calculator2 = Chapter06.LambdaDemo04_MethodReference.Calculator::add;
